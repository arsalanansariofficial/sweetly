...
type ScrollUpProps = React.ComponentProps<
  typeof SelectPrimitive.ScrollUpButton
>;

type ScrollDownProps = React.ComponentProps<
...
export function SelectValue({ ...props }: ValueProps) {
...
export function SelectScrollDownButton(props: ScrollDownProps) {
  return (
...
export function SelectScrollUpButton(props: ScrollUpProps) {
  return (
...
export function SelectContent(props: ContentProps) {
